...
import com.example.demo.SecretsManagerUtil;
...
import com.example.demo.model.FabricEnrollment;
import com.example.demo.model.FabricUser;
...
public class ManagedBlockchainService {
    ...
    public void invokeChaincode(HFClient hfClient, Channel channel, String chainCodeName, String functionName,
        ...
        // Set chaincode name, function and arguments
        ChaincodeID chaincodeID = ChaincodeID.newBuilder().setName(chainCodeName).build();
        ...
        invokeRequest.setProposalWaitTime(10000);
        ...
        try {
            ...
            CompletableFuture<Void> future = cf
                    .thenAccept((s) ->
                    {
                        long elapsedTime = (System.currentTimeMillis() - startTime2)/1000L;
                        log.info("Invoke Completed. Block nb:" + s.getBlockEvent().getBlockNumber() + ", elapsedTime: "+elapsedTime +" sec");
                    });

            log.debug("get(): " + future.get(10000, TimeUnit.MILLISECONDS));
        ...
        // 왜 이걸 잡았을까???
            ...
            long elapsedTime = (System.currentTimeMillis() - startTime1)/1000L;
            log.error("Timeout exception "+ e.getMessage() + ", elapsedTime: " + elapsedTime +" sec");
        }
        catch (Exception e) {
            long elapsedTime = (System.currentTimeMillis() - startTime1)/1000L;
            log.error("timeout after future.get()" + e.getMessage() + ", elapsedTime: " + elapsedTime +" sec");
        }
    }
}
